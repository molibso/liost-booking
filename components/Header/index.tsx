      ...
      > 
        ...
        >
          ...
          <div className="mt-1 flex items-center gap-4 xl:mt-0">
            ...
            >
              <Image
                src="https://liostevents.de/wp-content/uploads/TO256_Webbanner_1920x600_251105-1-1-1200x375.avif"
                alt="Liost events banner"
                width={1920}
                height={800}
                className="h-28 w-auto max-w-lg object-contain xl:h-32 xl:max-w-xl"
              />
            </a>
          </div>
        </div>
